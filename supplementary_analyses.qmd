...
```{r}
#| label: tbl-exp1a-pet
#| tbl-cap: "Experiment 1A: Model results for the effects of Character Pronoun and Question Type (character's pronoun or pet) on Memory Accuracy. Character Pronoun is contrast-coded as in the main analysis."
#| output: true
...
exp1a_tb_pets_all$knitr %<>%
  tab_model_title_row("Experiment 1A: Memory for Pronouns vs Pets") %>%
...
```{r}
#| label: tbl-exp1a-task
#| tbl-cap: "Experiment 1A: Model results for the effects of Pronoun and Task (memory vs production) on accuracy."
#| output: true
...
```{r}
#| label: tbl-exp1b-mem
#| tbl-cap: "Experiment 1B: Model results for the effect of Pronoun on Memory Accuracy, when the memory task was completed after the production task."
#| output: true
...
exp1b_tb_mem$knitr %<>%
  tab_model_title_row("Experiment 1B: Memory") %>%
  drop_sigma()
exp1b_tb_mem
```

```{r}
#| label: tbl-exp1b-prod
#| tbl-cap: "Experiment 1B: Model results for the effect of Pronoun on Production Accuracy, when the memory task was completed after the production task."
#| output: true
...
exp1b_tb_prod$knitr %<>%
  tab_model_title_row("Experiment 1B: Production") %>%
  drop_sigma()
exp1b_tb_prod
```

```{r}
#| label: exp1b-mp-table
#| output: true
#| results: asis
...
: Experiment 1B: Model results for the effects of Pronoun and Memory Accuracy on Production Accuracy, when the memory task was completed after the production task. {#tbl-exp1b-both}
...
```{r}
#| label: tbl-exp1b-pet
#| tbl-cap: "Experiment 1B: Model results for the effects of Character Pronoun and Question Type on accuracy in the pronoun and pet memory questions, when the memory task was completed after the production task."
#| output: true
...
exp1b_tb_pets_all$knitr %<>%
  tab_model_title_row("Experiment 1B: Memory for Pronouns vs Pets") %>%
  exp1_tb_random_labels() %>%
  drop_sigma()
exp1b_tb_pets_all
```
...
```{r}
#| label: tbl-exp1-mem
#| tbl-cap: "Experiments 1A & 1B: Model results for the effects of Pronoun and Task Order (Experiment 1A vs Experiment 1B) on Memory Accuracy."
#| output: true
...
exp1_tb_prod$knitr %<>%
  tab_model_title_row(paste(
    "Comparing Experiments 1A (Memory First) & 1B (Production First):<br>",
    "Production"
  )) %>%
  drop_sigma()
...
: Experiments 1A & 1B: Model results for the effects of Pronoun and Task Order (Experiment 1A vs Experiment 1B) on Production Accuracy. {#tbl-exp1-prod}
...
: Experiments 1A & 1B: Model results for the effects of Pronoun, Memory Accuracy, and Task Order (Experiment 1A vs Experiment 1B) on Production Accuracy. {#tbl-exp1-both}

<br>

```{r}
#| label: exp1-task-table
#| include: true
#| echo: false
#| warning: false
#| results: asis
...
: Experiments 1A & 1B: Model results for the effects of Pronoun and Task Order on the difference between memory accuracy and production accuracy for each participant. {#tbl-exp1-task}

<br>

```{r}
#| label: fig-exp1-reliability
#| fig-cap: "Experiments 1A & 1B: Correlations between by-participant random slopes for the effect of Pronoun in each half of the data, for the memory and production tasks."
#| fig-asp: 1
#| output: true
#| cache: true
...
```{r}
#| label: tbl-exp2-pet
#| tbl-cap: "Experiment 2: Model results for the effects of Character Pronoun, PSA, Biography, and Question Type on accuracy in the pronoun and pet memory questions."
#| output: true
...
exp2_tb_pets$knitr %<>%
  tab_model_title_row("Experiment 2: Memory for Pronouns vs Pets") %>%
  exp2_tb_random_labels() %>%
  drop_sigma()
exp2_tb_pets
```
...
```{r}
#| label: tbl-exp2-both
#| tbl-cap: "Experiment 2: Model results for the effects of Pronoun, PSA, Biography, and Memory Accuracy on Production Accuracy."
#| output: true
...
exp2_tb_mp$knitr %<>%
  tab_model_title_row("Experiment 2: Memory Predicting Production") %>%
  drop_sigma()
exp2_tb_mp
```
...
exp2_tb_use_they$knitr %<>%
  tab_model_title_row(
    "Experiment 2: Production of Singular <i>They</i>"
  )
...
```{r}
#| label: tbl-norming
#| tbl-cap: "Image Norming: Results. Counts and proportions of they/them, he/him, she/her, and no pronoun responses for each image in norming study."
#| output: true
...
```{r}
#| label: tbl-exp3-demographics2
#| tbl-cap: "Experiment 3: Additional Demographics. Race/ethnicity has a higher total, as participants could select more than one option."
#| output: true
...
```{r}
#| label: tbl-exp3-ratings
#| tbl-cap: "Experiment 3: Naturalness Ratings. Model results for the effect of Referent Type (generic, each, every vs masculine, feminine, gender-neutral names) on sentence naturalness ratings for singular *they*."
#| output: true
...
exp3_tb_ratings$knitr %<>%
  tab_model_title_row(
    "Experiment 3: Naturalness Ratings for Singular <i>They"
  ) %>%
...
```{r}
#| label: tbl-exp3-gender-beliefs
#| tbl-cap: "Experiment 3: Gender Beliefs. Question texts, distributions, means, and SDs for items in the gender beliefs scale [@nagoshi2008]."
#| output: true
...
#| fig-cap: "Experiment 3: [A] Distribution of pronouns produced for each of the 6 character images. [B] Mean accuracy for each of the 18 name + image + pronoun combinations, summarized across Nametag & Introduction conditions. Error bars indicate 95% CIs calculated over the by-item means."
#| fig-width: 6.5
#| fig-height: 5
#| output: true
#| cache: true
...
```{r}
#| label: tbl-exp3-cov
#| tbl-cap: "Experiment 3: Model results for the effects of Pronoun, Nametag, Introduction, Gender Beliefs, and Familiarity with Pronoun Sharing on accuracy."
#| output: true
...
exp3_tb_subj_cov$knitr %<>%
  tab_model_title_row("Experiment 3: Participant Covariates") %>%
  drop_sigma() %>%
  exp3_tb_random_labels() %>%
...
```{r}
#| label: tbl-exp4-gender-beliefs
#| tbl-cap: "Experiment 4: Gender Beliefs. Question texts, distributions, means, and SDs for items in the gender beliefs scale [@nagoshi2008]."
#| output: true
...
```{r}
#| label: tbl-exp4-ratings
#| tbl-cap: "Experiment 4: Model results for the effect of Referent Type (generics, each, every vs masculine, feminine, gender-neutral names) on sentence naturalness ratings for singular *they.*"
#| output: asis
...
exp4_tb_ratings$knitr %<>%
  exp4_tb_random_effects() %>%
  tab_model_title_row(
    "Experiment 4: Naturalness Ratings for Singular <i>They</i>"
  )
exp4_tb_ratings
```
...
<br>
```{r}
#| label: tbl-exp4-match-CR
#| tbl-cap: "Experiment 4: Test Trial Match Rates. Model results for the effect of Pronoun Pair on the likelihood of judging the story to match the scene in test trials."
#| output: asis
...
exp4_tb_match_CR$knitr %<>%
  tab_model_title_row("Experiment 4: Match Judgment Rates in Test Trials") %>%
  exp4_tb_random_effects() %>%
...
```{r}
#| label: tbl-exp4-match-FP
#| tbl-cap: "Experiment 4: Wrong Pronoun Trial Match Rates. Model results for the effect of Pronoun on judging the story to match the scene in wrong pronoun trials. There were no wrong pronoun trials for the HeShe|They condition, so They|HeShe (they/them character referred to with he/him or she/her, whichever the competitor did not use) and HeShe|SheHe (he/him and she/her characters referred to with they/them) were mean-center effects coded."
#| output: asis
...
```{r}
#| label: tbl-exp4-match-RT
#| tbl-cap: "Experiment 4: Test Trial Match RT. Model results for the effect of Pronoun Pair on reaction times for test trial match judgments."
#| output: asis
...
exp4_tb_match_RT <- tab_model(
  ...
  title = "Experiment 4: Match Judgment RT in Test Trials",
  wrap.labels = 80,
  CSS = table_css
)
exp4_tb_match_RT$knitr %<>%
  ...
  str_replace_all(
    str_c(blank_row4, "0.092"),
    str_c(
      blank_row1,
      "&rho;<sub>01 Pronoun Pair (HS|T vs HS|SH) | Participant</sub></td>",
      blank_row4, "0.092"
  )) %>%
  tab_model_title_row("Experiment 4: Match Judgment RT in Test Trials")
...
```{r}
#| label: tbl-exp4-HS-SH
#| tbl-cap: "Experiment 4: Model results for the effects of Pronoun and Order on the likelihood of looking at the target character (1) or not (0). The HeShe|SheHe condition is coded as 0, and the HeShe|They and They|HeShe conditions are coded as 1."
#| output: true
#| results: asis
...
exp4_tb_HS.SH$knitr %<>%
  tab_model_title_row(paste(
    "Experiment 4: Looks to the Target Character<br>",
...
```{r}
#| label: tbl-exp4-HS-T
#| tbl-cap: "Experiment 4: Model results for the effects of Pronoun and Order on the likelihood of looking at the target character (1) or not (0). The HeShe|They condition is coded as 0, and the HeShe|SheHe and They|HeShe conditions are coded as 1."
#| output: true
#| results: asis
...
```{r}
#| label: tbl-exp4-T-HS
#| tbl-cap: "Experiment 4: Model results for the effects of Pronoun and Order on the likelihood of looking at the target character (1) or not (0). The They|HeShe condition is coded as 0, and the HeShe|They and HeShe|SheHe conditions are coded as 1."
#| output: true
#| results: asis
...
```{r}
#| label: tbl-exp4-target-pronoun
#| tbl-cap: "Experiment 4: Model results for the effects of Target Pronoun and Order on the likelihood of looks to the target character, during the window starting 200ms after pronoun onset and ending at 1210ms, the earliest shape word onset."
#| output: true
#| results: asis
...
exp4_tb_target_pronoun$knitr %<>% 
  tab_model_title_row("Experiment 4: Target Pronoun") %>%
  exp4_tb_random_effects() %>%
  drop_sigma()
...
```{r}
#| label: tbl-exp4-trend
#| tbl-cap: "Experiment 4: Trend Interactions. Model results for the interactions between Trend and Pronoun Pair and Order on the likelihood of looking at the target character."
#| output: true
#| results: asis
...
exp4_tb_trend$knitr %<>%
  tab_model_title_row("Experiment 4: Interactions with Trend") %>%
  exp4_tb_random_effects() %>%
  str_replace_all(  # bug in tab_model that drops rho labels
    "&rho;<sub>01</sub>",
...
```{r}
#| label: tbl-exp4-AR
#| tbl-cap: "Experiment 4: AR(1) Interactions. Model results for the interactions between AR(1) and Pronoun Pair and Order on the likelihood of looking at the target character."
#| output: true
#| results: asis
...
exp4_tb_AR$knitr %<>%
  tab_model_title_row("Experiment 4: Interactions with AR(1)") %>%
  exp4_tb_random_effects() %>%
  str_replace_all(  # bug in tab_model that drops rho labels
