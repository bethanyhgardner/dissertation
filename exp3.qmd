...
```{r}
#| label: fig-exp3-corr
#| fig-cap: "Experiment 3: Correlations Between Participant Covariates. <br>Age, LGBTQ+ identity, familiarity with using they/them pronouns and <br>pronoun sharing practices, naturalness ratings for sg. *they* coreferring <br>with indefinite referents (generics, *each*, *every*) and with proper names."
#| fig-width: 4.5
#| fig-height: 4
#| out-width: "55%"
#| output: true
